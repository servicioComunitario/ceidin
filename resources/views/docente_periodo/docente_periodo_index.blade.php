...
@section('contenido')	
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
            <h1 class="">Listado Profesores Asignados a este pediodo escolar</h1>
        </div>
    </div>
	
	@include('docente_periodo._form', ['docente_periodo' => $docente_periodo, 'periodo' => $periodo, 'docentes_sin_asignar' => $docentes_sin_asignar])
    @include('docente_periodo._modal')
    @include('docente_periodo.docente_table', ['docentes' => $docente_periodo])
@endsection
